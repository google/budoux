...
class TestFindConflicts(unittest.TestCase):
  ...
  def test_no_conflicts(self) -> None:
    ...
    find_conflicts.find_conflicts(self.input_file, self.output_file, threshold=1.0)
  ...
  def test_threshold_keeps_majority_summing_weights(self) -> None:
    ...
    find_conflicts.find_conflicts(self.input_file, self.output_file, threshold=0.8)
